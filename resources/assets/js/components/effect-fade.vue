...
<template>
  <div>
    <div class="btn-group btn-vue-example">
      <button class="btn btn-default btn-xs btn-title">effect-fade</button>
      <button class="btn btn-default btn-xs btn-title">渐变效果</button>
      <a href="https://github.com/surmon-china/vue-awesome-swiper/blob/master/examples/16-effect-fade.vue" target="_blank" class="btn btn-primary btn-xs">&lt; &gt;</a>
    </div>
